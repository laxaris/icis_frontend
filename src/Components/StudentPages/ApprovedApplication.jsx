...
const ApprovedApplication = () => {
    ...
    const handleApproveReject = async (applicationId, isApprove) => {
        ...
        try {
            const response = await axios.post(`https://icis-production.up.railway.app:7622/api/studentapprovedapplications/${applicationId}`, {}, {
                headers: {
                    "Authorization": `${token}`,
                    "isApprove": isApprove
                }
    ...
    const fetchstudents = async () => {
        const token = Cookies.get("jwtToken");
        try {
            const response = await axios.get("https://icis-production.up.railway.app:7622/api/studentapprovedapplications", {
