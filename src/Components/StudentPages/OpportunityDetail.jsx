...
const OpportunityDetail = () => {
    ...
    const handleApply = async () => {
        ...
        try {
            const response = await axios.post(`http://icisbackend-production.up.railway.app/api/applyinternship/${offerid}`, {}, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    const fetchOpportunity = async () => {
        try {
            const token = Cookies.get('jwtToken');
            const response = await axios.get(`http://icisbackend-production.up.railway.app/api/showoffers/${offerid}`, {
