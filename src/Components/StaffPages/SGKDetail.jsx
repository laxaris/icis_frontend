...
const SGKDetail = () => {
    ...
    const fetchOpportunityDetails = async () => {
        try {
            const token = Cookies.get("jwtToken");
            const response = await axios.get(`http://icisbackend-production.up.railway.app/api/staffshowinternshipsstarted/${applicationId}`, {
    ...
    const uploadFile = async () => {
        ...
        try {
            const token = Cookies.get("jwtToken");
            const response = await axios.post(`http://icisbackend-production.up.railway.app/api/uploadsgkdocument/${applicationId}`, formData, {
                headers: {
                    "Authorization": `${token}`,
