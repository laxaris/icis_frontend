...
const ApproveFormDetail = () => {
    ...
    const handleApproveReject = async (isApprove) => {
        ...
        try {
            const response = await axios.post(`http://icisbackend-production.up.railway.app/api/approveapplicationform/${applicationId}`,{},{
                headers: {
                    "Authorization": `${token}`,
    ...
    const fetchOpportunityDetails = async () => {
        try {
            const token = Cookies.get("jwtToken");
            const response = await axios.get(`http://icisbackend-production.up.railway.app/api/approveforms/${applicationId}`, {
