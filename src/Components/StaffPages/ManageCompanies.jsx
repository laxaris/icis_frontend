...
const ManageCompanies = () => {
    ...
    const handleApproveReject = async (companyId, isApprove) => {
        ...
        try {
            const response = await axios.post(`https://icis-production.up.railway.app:7622/api/managecompanyapplication/${companyId}`, {}, {
                headers: {
                    "Authorization": `${token}`,
    ...
    const fetchCompanies = async () => {
        const token = Cookies.get("jwtToken");
        try {
            const response = await axios.get("https://icis-production.up.railway.app:7622/api/managecompanyapplication", {
